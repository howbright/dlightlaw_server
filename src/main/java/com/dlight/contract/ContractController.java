...
public class ContractController {
	...
	@CrossOrigin("*")
	@RequestMapping(value="/contract-sample", method = RequestMethod.GET)
	public String createSimpleTable(Model model) throws Exception {
	...
	public String contract(Model model) throws Exception {
		model.addAttribute("message", "Hello World!");
...
//    private static final String EXTERNAL_FILE_PATH="C:/mytemp/SpringMVCHibernateManyToManyCRUDExample.zip";
    private static final String EXTERNAL_FILE_PATH="/Users/hyun/Dlight/contracts/cccc.docx";
...
//        }
        ...
        file = new File("/Users/hyun/Dlight/contracts/"+filename);
        if(!file.exists()){
