...
import com.dlight.server.properties.MasterDatabaseProperties;
...
@MapperScan(basePackages = {"com.dlight"}, sqlSessionFactoryRef = "masterSqlSessionFactory")
class DefaultDatabaseConfig extends DatabaseConfig {
	...
	public SqlSessionFactory masterSqlSessionFactory() throws Exception {
		...
		sessionFactoryBean.setTypeAliasesPackage("com.dlight");
